<?php
/*
* Template Name: tu-van-nuoc-thai
*/
?>
<?php get_header(); ?>
<div id="content">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="ct-post">
                        <div class="mcn-title-post text-left custom-title-page">
                            <h2><span>Tư vấn xử lý nước thải</span></h2>
                        </div>
                        <div id="container">
                            <div class="td-pb-span12">
                                <div class="td-category-description">
                                    <p style="text-align: justify;">CÔNG TY TNHH THƯƠNG MẠI VÀ KĨ THUẬT CÔNG NGỆ QUÝ
                                        ...
                                        thải.</p>
                                    &nbsp;
                                    <h1 style="font-size: 22px">Sơ lược về công ty </h1>
                                    &nbsp;
                                    <p>
                                        ...
                                        <strong> hệ thống xử lý nước thải</strong> áp dụng nhiều <strong>công
                                            nghệ
                                            xử lý nước thải</strong> phù hợp với từng loại nước thải như:
                                        <em>
                                            nước thải sinh hoat, nước thải sản xuất, nước thải chăn nuôi heo,
                                            nước
                                            thải công nghiệp, nước thải thủy sản, nước thải bệnh viện, nước thải
                                            phòng khám đa khoa, nước thải y tế, xử lý nước thải xi mạ, nước thải
                                            dệt
                                            nhuộm...
                                        </em>
                                    </p>
                                    ...
                                    <p>
                                        ...
                                        <strong>cải tạo hệ thống xử lý nước thải</strong> với các công nghệ hiện
                                        đại
                                    ...
                                    Dưới đây là hình ảnh từ các <strong>công trình xử lý nước thải</strong> cũng
                                    như
                                    các bài viết chia sẽ kinh nghiệm
                                    ...
                                    Liên kết:
                                    <strong>
                                        <a href="http://moitruongdgp.com/he-thong-xu-ly-khi-thai/" rel="dofollow" target="_blank">Đăng kí môi trường</a> |
                                        <a href="http://moitruongdgp.com/thiet-ke-phong-sach/" rel="dofollow" target="_blank">Giấy phép môi trường</a>
                                        |
                                        <a href="http://moitruongdgp.com/cam-ket-bao-ve-moi-truong/" rel="dofollow" target="_blank">Đánh giá tác động
                                            môi trường</a>
                                    </strong>
                                    <p></p>
                                </div>
