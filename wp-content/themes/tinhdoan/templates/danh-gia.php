            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="box_mucluc">
                        <div class="fix-toc">
                            <div class="toctitle" style="line-height: 25px;"><img class="toctoggle" src="https://cdn.thuvienphapluat.vn/images/mluc.png" alt="Mục lục bài viết" />Mục lục bài viết</div>
                            <ul>
                                <li class="toclevel-1">
                                    <a href="javascript:void(0)" onclick="_scrollTo('ancho1')"><span class="id-list">1. Đánh giá tác động môi trường là gì?</span></a>
                                </li>
                                <li class="toclevel-1">
                                    <a href="javascript:void(0)" onclick="_scrollTo('ancho2')"><span class="id-list">2. Đối tượng phải thực hiện đánh giá tác động môi
                                            trường</span></a>
                                </li>
                                <li class="toclevel-1">
                                    <a href="javascript:void(0)" onclick="_scrollTo('ancho3')"><span class="id-list">3. Thời điểm, đối tượng thực hiện đánh giá tác động môi
                                            trường</span></a>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div class="newcontent">
                        <p>
                            <img alt="Đánh giá tác động môi trường là gì? Đối tượng nào phải thực hiện?" src="https://cdn.thuvienphapluat.vn//uploads/tintuc/2022/04/25/danh-gia-tac-dong-moi-truong.jpg" style="width: 560px; height: 467px;" />
                        </p>
                    ...
                    <p>(Khoản 7 Điều 3 <a href="https://thuvienphapluat.vn/van-ban/Tai-nguyen-Moi-truong/Luat-so-72-2020-QH14-Bao-ve-moi-truong-2020-431147.aspx" target="_blank">Luật Bảo vệ môi trường 2020</a>)</p>
                    <br>
                    <h2 id="ancho2">
                    ...
                    <p>(Điều 30 <a href="https://thuvienphapluat.vn/van-ban/Tai-nguyen-Moi-truong/Luat-so-72-2020-QH14-Bao-ve-moi-truong-2020-431147.aspx" target="_blank">Luật Bảo vệ môi trường 2020</a>)</p>
                    ...
                    <p>(Điều 31 <a href="https://thuvienphapluat.vn/van-ban/Tai-nguyen-Moi-truong/Luat-so-72-2020-QH14-Bao-ve-moi-truong-2020-431147.aspx" target="_blank">Luật Bảo vệ môi trường 2020</a>)</p>
